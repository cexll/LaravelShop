                    ...
                    <td colspan="4">
                        <form action="{{ route('admin.orders.ship', [$order->id]) }}" method="post" class="form-inline">
                            ...
                            <div class="form-group {{ $errors->has('express_company') ? 'has-error' : '' }}">
                                <label class="control-label" for="express_company">物流公司</label>
                            ...
                            <div class="form-group {{ $errors->has('express_no') ? 'has-error' : '' }}">
                                <label class="control-label" for="express_no">物流单号</label>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($order->refund_status === \App\Models\Order::REFUND_STATUS_APPLIED)
                                <button class="btn btn-sn btn-success" id="btn-refund-agree">同意</button>
                                <button class="btn btn-sn btn-danger" id="btn-refund-disagree">不同意</button>
                            @endif
                        </td>
                    </tr>
                @endif
