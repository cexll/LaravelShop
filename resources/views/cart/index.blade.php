                        ...
                        @foreach($cartItems as $item)
                            <tr data-id="{{ $item->productSku->id }}">
                                ...
                                <div @if(!$item->productSku->product->on_sale) class="not_on_sale" @endif>
                                    ...
                                    <p></p>
                                    <span class="price" style="color: red">单价: ￥{{ $item->productSku->price }}</span>
                                    <p></p>
                        ...
                        <form class="form-horizontal" role="form" id="order-form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <span class="help_block" id="coupon_desc"></span>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="offset-sm-3 col-sm-3">
                                    <button type="button" class="btn btn-primary btn-create-order float-right">提交订单</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-create-order').click(function () {
                ...
                // 遍历 <table> 标签内所有带有data-id属性的 <tr> 标签,也就是每一个购物车中的商品 SKU
            ...
            $('#btn-check-coupon').click(function () {
                ...
                axios.get('/coupon_codes/' + encodeURIComponent(code))
                    .then(function (response) {
                        $('#coupon_desc').text(response.data.description); //输入优惠信息
